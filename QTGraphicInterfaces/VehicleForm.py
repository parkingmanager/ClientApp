...
"}")
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(20, 60, 431, 304))
        ...
        self.txb_class_2 = QtWidgets.QComboBox(self.formLayoutWidget)
        self.txb_class_2.setEditable(True)
        self.txb_class_2.setObjectName("txb_class_2")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.txb_class_2)
        ...
        self.btn_ok.setGeometry(QtCore.QRect(20, 370, 75, 23))
        self.btn_ok.setObjectName("btn_ok")
        self.btn_cancel = QtWidgets.QPushButton(self.centralwidget)
        self.btn_cancel.setGeometry(QtCore.QRect(380, 370, 75, 23))
